...
cor_color_all = [correct_color_order_0,correct_color_order_1,correct_color_order_2,correct_color_order_3]
...
for trial in range(4):
    ...
    while not clicked_check:
        ...
        for pk in puzzlekey:
            for t in tiles:
                ...
                if t.contains(center) and not mouse.isPressedIn(check_button):
    ...
    result = visual.TextStim(win,text='you got '+str(total_correct)+' correct!', font='Times', units='pix', pos=(0,-100),height=65, color="#000000")
    result.draw()
    win.flip()
